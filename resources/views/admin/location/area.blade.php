            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Area List</h4>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody id="positionSorting" data-table="areas">
                                            @foreach($areas as $data)
                                            <tr id="item{{$data->id}}">
                                                <td>{{$data->name}}</td>
                                                <td>@if($data->city){{$data->city->name}}@endif</td>
                                                ...
                                                <td>
                                                    ...
                                                    <button data-target="#delete" onclick="deleteConfirmPopup('{{route("area.delete", $data->id)}}')" class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i> Delete</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
            ...
            <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body form-row">
                        <div class="card-body">
                            <form action="{{route('area.store')}}" method="POST" class="floating-labels">
                                {{csrf_field()}}
                                <div class="form-body">
                                    <!--/row-->
                                    <div class="row justify-content-md-center">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea style="resize: vertical;" name="name" id="name" value="{{old('name')}}" required="" type="text" placeholder="Sector:3 Uttara * gulshan 2" class="form-control"></textarea>
                                                <i style="color:red">Upload multiple area separated by Star[*]</i> 
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-md-center">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <span for="city">City Name</span>
                                                <select required name="city_id" id="city" class="form-control select2 custom-select">
                                                    <option value="">Select city</option>
                                                    @foreach($cities as $city)
                                                        <option @if(Session::get('autoSelectId') == $city->id) selected @endif value="{{$city->id}}">{{$city->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
