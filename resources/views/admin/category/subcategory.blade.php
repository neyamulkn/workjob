                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <button data-toggle="modal" data-target="#add" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Add New Category</button>@endif
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody id="categoryPositionSorting">
                                            ...
                                            <tr id="item{{$data->id}}">
                                                ...
                                                <td><img src="{{asset('upload/images/category/thumb/'. $data->image)}}" width="50" alt=""></td>
                                                <td>{{$data->name}}</td>
                                                
                                                <td>{{($data->get_category->name ) ?? 'Not found'}}</td>
                                                @if($permission['is_edit'])
                                                <td><input style="width: 100px;" value="{{$data->free_ads_limit}}" onkeyup ="freeAdsLimit({{$data->id}}, this.value )" type="number" class="form-control" name=""></td>@endif
                                                <td>{{$data->notes}}</td>
                                                <td> 
                                                     @if($permission['is_edit'])
                                                ...
                                                <td>
                                                    ...
                                                    <button data-target="#delete" onclick="deleteConfirmPopup('{{route("subcategory.delete", $data->id)}}')" class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i> Delete</button>@endif
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
...
@section('js')
    ...
    $(document).ready(function() {
        ...
        function freeAdsLimit(category, adslimit){
            ...
            var  url = '{{route("admin.setAdsLimit")}}';
            if(adslimit){
            $.ajax({
                url:url,
                method:"get",
