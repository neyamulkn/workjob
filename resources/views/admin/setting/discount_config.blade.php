            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor"><a href="{{ url()->previous() }}"> <i class="fa fa-angle-left"></i>Discount configuration</a></h4>
                    </div>
                </div>
                <!-- ============================================================== -->
                                ...
                                <div class="tab-content tabcontent-border">
                                   <?php
                                    ...
                                    <div class="tab-pane active" id="Ads Limit" role="tabpanel">
                                        <div class="p-20">
                                            <form action="{{ route('siteSettingUpdate') }}"  method="post" data-parsley-validate id="discount_config">
                                                @csrf
                                                ...
                                                <div class="form-body">
                                                    <div class="">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input style="width: 300px" name="value" min="0" id="title" value="{{ $discount_config->value }}" type="number" placeholder="Example 10% " class="form-control"><br>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input style="width: 300px" required="" name="value2" min="0" id="title" value="{{ $discount_config->value2 }}" type="number" placeholder="Example 5" class="form-control">
                                                            </div> 
                                                        </div>
                                                        <!-- <div class="form-group row">
                                                            <label class="col-md-2 text-right col-form-label" for="Ads Limit_site_key">Job Post Discount</label>
                                                            <div class="col-md-6">
                                                                <input style="width: 300px" name="value3" min="0" id="title" value="{{ $discount_config->value3 }}" type="number" placeholder="Example 10% " class="form-control">
                                                            </div> 
                                                        </div> -->
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-4">
                                                                    <label for="active"> <input type="radio" name="status" value="1"  {{ ($discount_config->status == '1') ? 'checked' : '' }} id="active">
                                                                    Active</label> 
                                                                    <label for="DeActive"> <input type="radio" name="status" value="0"  {{ ($discount_config->status == '0') ? 'checked' : '' }} id="DeActive">
                                                                    DeActive</label>
                                                            </div>
                                                        </div>
