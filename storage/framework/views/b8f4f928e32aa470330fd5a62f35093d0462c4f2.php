                                ...
                                <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list"
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <td><?php echo e($ticket->ticket_price); ?></td>

                                            <td><?php echo e(Carbon\Carbon::parse($ticket->start_date)->format('d M, Y')); ?></td>
                                            <td><?php echo e(Carbon\Carbon::parse($ticket->end_date)->format('d M, Y')); ?> </td>
                                            ...
                                            <td>
                                                ...
                                                <button title="Edit Ticket" type="button" onclick="edit(<?php echo e($ticket->id); ?>)"  data-toggle="modal" data-target="#edit" class="btn btn-info btn-sm"><i class="ti-pencil" aria-hidden="true"></i></button>
                                                <button title="Delete ticket" data-target="#delete" onclick="deleteConfirmPopup("<?php echo e(route('ticket.delete', $ticket->id)); ?>")" class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i> </button>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xmapp\htdocs\workupjob\resources\views/admin/ticket/ticket-list.blade.php ENDPATH**/ ?>