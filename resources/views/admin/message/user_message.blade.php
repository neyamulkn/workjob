...
@section('title', 'User conversation list')
@section('css-top')
                            ...
                            <div class="chat-left-aside">
                                ...
                                <div class="chat-left-inner">
                                    ...
                                    <ul class="chatonline style-none contacts" id="user-lists">
                                        ...
                                        @if($conversationUser->product)
                                        <li>
                                            <a onclick="message({{$conversationUser->id}})" style="display: flex;" href="javascript:void(0)">
                                            	<div class="avatar online-active">
                                            		<img src="{{ asset('upload/images/product/thumb/'.$conversationUser->product->feature_image) }}" alt="user-img" class="img-circle">
                                            	</div>
                                            	<div class="content">
                                                    <span>{{ Str::limit($conversationUser->product->title, 35)}}</span>
                                                    <p class="text">{{ Str::limit($conversationUser->last_message->message, 25) }}</p>
                                                    <i class="time">{{Carbon\Carbon::parse($conversationUser->last_message->created_at)->diffForHumans()}}</i>
                                                </div> 
                                            </a>
                                        </li>
                                        @endif
...
@section('js')
	...
	<script>
	    ...
	    function message(username){
	        ...
	        var  link = '{{route("getConversations", ":username")}}';
	        ...
	        var path = "{{route('userConversations')}}/"+username;
