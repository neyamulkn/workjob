                                ...
                                <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($tickets as $ticket)
                                            ...
                                            <td>{{Carbon\Carbon::parse($ticket->start_date)->format('d M, Y')}}</td>
                                            <td>{{Carbon\Carbon::parse($ticket->end_date)->format('d M, Y')}} </td>
                                            ...
                                            <td>
                                                ...
                                                <button title="Delete ticket" data-target="#delete" onclick="deleteConfirmPopup("{{ route('ticket.delete', $ticket->id) }}")" class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i> </button>
                                            </td>
                                        </tr>
                                        @endforeach
