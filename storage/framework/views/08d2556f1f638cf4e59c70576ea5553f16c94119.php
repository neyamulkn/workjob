...
<?php $__env->startSection('title', 'Zone list'); ?>
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Zone List</h4>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $zones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr id="item<?php echo e($data->id); ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <button data-target="#delete" onclick="deleteConfirmPopup('<?php echo e(route("zone.delete", $data->id)); ?>')"  class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i> Delete</button>
                                                </td>
                                            </tr>
            ...
            <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body form-row">
                        <div class="card-body">
                            <form action="<?php echo e(route('zone.store')); ?>" method="POST" class="floating-labels">
        ...
        <!-- update Modal -->
          <div class="modal fade" id="edit" role="dialog"  tabindex="-1" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <form action="<?php echo e(route('zone.update')); ?>"  method="post">
                      <?php echo e(csrf_field()); ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript">
      ...
      function edit(id){
            ...
            var  url = '<?php echo e(route("zone.edit", ":id")); ?>';
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xmapp\htdocs\workupjob\resources\views/admin/location/zone.blade.php ENDPATH**/ ?>