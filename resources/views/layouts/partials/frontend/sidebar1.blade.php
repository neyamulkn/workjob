    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li> <a class="waves-effect waves-dark" href="{{route('verifyAccount')}}" aria-expanded="false"><i class="fa fa-check-circle"></i><span class="hide-menu">Verify Account</span></a></li>
