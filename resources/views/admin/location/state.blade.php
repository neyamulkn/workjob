            ...
            <div class="container-fluid">
                                        ...
                                        <tbody id="positionSorting" data-table="states">
                                            ...
                                            <tr id="item{{$data->id}}">
                                                ...
                                                <td>
                                                    ...
                                                    <button data-target="#delete" onclick="deleteConfirmPopup('{{route("state.delete", $data->id)}}')" class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i> Delete</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                ...
                <div class="row">
                   <div class="col-sm-6 col-md-6 col-lg-6 text-center">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6 text-right">Showing {{ $states->firstItem() }} to {{ $states->lastItem() }} of total {{$states->total()}} entries ({{$states->lastPage()}} Pages)</div>
                </div>
                <!-- ============================================================== -->
                <!-- End PAge Content -->
                <!-- ============================================================== -->
            ...
            <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body form-row">
                        <div class="card-body">
                            <form action="{{route('state.store')}}" method="POST" class="floating-labels">
                                {{csrf_field()}}
                                <div class="form-body">
                                    <!--/row-->
