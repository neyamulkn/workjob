                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <button data-toggle="modal" data-target="#add" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Add New banner</button>@endif
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <select name="page"  id="page" style="width:100%" id="page" class="select2 form-control custom-select">
                                                       ...
                                                       <option @if(Request::get('page') == $page->slug) selected @endif value="{{$page->slug}}">{{$page->title}}</option>
                                                       @endforeach
                                                   </select>
                                               </div>
                                            </div>
                                            ...
                                            <tr id="item{{$banner->id}}">
                                                ...
                                                <td>
                                                    <div class="custom-control custom-switch">
                                                      <input  name="status" @if($permission['is_edit']) onclick="satusActiveDeactive('banners', {{$banner->id}})" @endif type="checkbox" {{($banner->status == 1) ? 'checked' : ''}}  type="checkbox" class="custom-control-input" id="status{{$banner->id}}">
                                                      <label style="padding: 5px 12px" class="custom-control-label" for="status{{$banner->id}}"></label>
                                                
                                                    </div>
                                                </td>
                                                <td>@if($permission['is_edit'])
                                                    <button type="button" onclick="edit('{{$banner->id}}')"  data-toggle="modal" data-target="#edit" class="btn btn-info btn-sm"><i class="ti-pencil" aria-hidden="true"></i> </button>@endif
                                                    @if($permission['is_delete'])
                                                    <button data-target="#delete" onclick="deleteConfirmPopup('{{route("banner.delete", $banner->id)}}')" class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i> </button>@endif
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
