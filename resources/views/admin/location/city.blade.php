            ...
            <div class="container-fluid">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody id="positionSorting" data-table="cities">
                                            ...
                                            <tr id="item{{$data->id}}">
                                                <td>{{$data->name}}</td>
                                                <td>@if($data->state){{$data->state->name}}@endif</td>
                                                ...
                                                <td>
                                                    ...
                                                    <button data-target="#delete" onclick="deleteConfirmPopup('{{route("city.delete", $data->id)}}')" class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i> Delete</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                ...
                <div class="row">
                   <div class="col-sm-6 col-md-6 col-lg-6 text-center">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6 text-right">Showing {{ $cities->firstItem() }} to {{ $cities->lastItem() }} of total {{$cities->total()}} entries ({{$cities->lastPage()}} Pages)</div>
                </div>
                <!-- ============================================================== -->
                <!-- End PAge Content -->
                <!-- ============================================================== -->
            ...
            <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body form-row">
                        <div class="card-body">
                            <form action="{{route('city.store')}}" method="POST" class="floating-labels">
                                {{csrf_field()}}
                                <div class="form-body">
                                    <!--/row-->
                                    <div class="row justify-content-md-center">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea style="resize: vertical;"  name="name" id="name" value="{{old('name')}}" required="" type="text" class="form-control" placeholder="Rangpur * dhaka * Rajshahi"></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select required name="state_id" id="state" class="select2 form-control custom-select">
                                                    ...
                                                    @foreach($states as $state)
                                                        <option  @if(Session::get('autoSelectId') == $state->id) selected @endif  value="{{$state->id}}">{{$state->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
