            ...
            <div class="container-fluid" style="text-align:center;">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="head  clockdiv" style="margin: 10px 0;" data-date="<?php echo e(Carbon\Carbon::parse($ticket->end_date)); ?>">
                            <div class="count">
                              <div class="count_d" >
                    ...
                    <div class="col-md-5">
                        <div class="card">
                            <div data-toggle="modal" title="Buy Ticket" style="height: 123px;cursor: pointer;" data-target="#add" class="ext-center">
                                <img style="width: 100%;height: 100%;" src="<?php echo e(asset('upload/images/ticket')); ?>/<?php echo e(($ticket && $ticket->banner) ? $ticket->banner : 'defualt.png'); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex no-block align-items-center">
                                    ...
                                    <a href="#" class="link display-5 ml-auto"><?php echo e($seasonTickets); ?></a>,
                                    <h6 class="">All Time</h6>
                                    <a href="#" class="link display-5 ml-auto"><?php echo e($myAllTicket); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table product-overview">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $topTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $topTicket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($index+1); ?></td>
                                                <td><?php echo e($topTicket->user->name); ?></td>
                                                <td><?php echo e($topTicket->tickets); ?></td>
                                            </tr>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive ">
                                    <table class="table product-overview">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $recentTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $recentTicket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($index+1); ?></td>
                                                <td><?php echo e($recentTicket->user->name); ?></td>
                                                <td><?php echo e($recentTicket->tickets); ?></td>
                                            </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
                                    </table>
            ...
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body form-row">
                        <div class="card-body">
                            <?php if($ticket && $ticket->end_date> now()): ?>
                            <form action="<?php echo e(route('buyTicket')); ?>" method="POST" >
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <h4>Per Ticket: <?php echo e(config('siteSetting.currency_symble'). $ticket->ticket_price); ?></h4>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xmapp\htdocs\workupjob\resources\views/users/ticket/ticket.blade.php ENDPATH**/ ?>