                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="position"  required="required" id="position" class="form-control custom-select">
                                                    ...
                                                    <option value="top-content" {{ (old('position') == 'top-content') ? 'selected' : '' }}>Top Of the Content</option>
                                                    <option value="middle-content" {{ (old('position') =='middle-content') ? 'selected' : '' }}>Middle Of the Content</option>
                                                    <option value="bottom-content" {{ (old('position') =='bottom-content') ? 'selected' : '' }}>Bottom Of the Content</option>
                                                    <option value="sidebar-top" {{ (old('position') =='sidebar-top') ? 'selected' : '' }}>Sidebar Top </option>
                                                   <option value="sidebar-middle" {{ (old('position') =='sidebar-middle') ? 'selected' : '' }}>Sidebar Middle </option>

                                                   <option value="sidebar-bottom" {{ (old('position') =='sidebar-middle') ? 'selected' : '' }}>Sidebar Bottom </option>
