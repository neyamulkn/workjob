                                        ...
                                        <tbody id="positionSorting" data-table="socials">
                                            ...
                                            <tr id="item{{$data->id}}" >
                                                ...
                                                <td>
                                                    ...
                                                    <button title="Delete" data-target="#delete" onclick="deleteConfirmPopup('{{route("socialSettingDelete", $data->id)}}')" class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i> </button>@endif
                                                </td>
                                            </tr>
                                            @endforeach
                                            @else
