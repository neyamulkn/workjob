                                            ...
                                            <tr id="item{{$data->id}}">
                                                ...
                                                <td>
                                                    <div class="custom-control custom-switch" style="padding-left: 3.25rem;">
                                                      <input name="status" @if($permission['is_edit']) onclick="satusActiveDeactive('menus', {{$data->id}})" @endif type="checkbox" {{($data->status == 1) ? 'checked' : ''}} class="custom-control-input" id="status{{$data->id}}">
                                                ...
                                                <td>
                                                    ...
                                                    <button title="Delete" data-target="#delete" onclick="deleteConfirmPopup('{{route("menu.delete", $data->id)}}')" class="btn btn-danger btn-sm" data-toggle="modal"><i class="ti-trash" aria-hidden="true"></i> </button>@endif
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
