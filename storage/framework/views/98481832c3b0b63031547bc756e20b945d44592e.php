...
<?php $__env->startSection('title', 'All works'); ?>
			                        ...
			                        <table id="config-table" class="table table-hover table-bordered table-striped">
			                            ...
			                            <tbody>
			                                ...
			                                <tr id="item<?php echo e($myWork->id); ?>">
                                                ...
                                                <td><?php echo e($myWork->user->name); ?></td>
			                                    ...
			                                    <td>
			                                         <a target="_blank" class="btn-sm btn-info" title="View job details" href="<?php echo e(route('job_details',[$myWork->job->slug])); ?>"><i class="ti-eye"></i> View job </a>                        
			                                    </td>
			                                </tr>
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xmapp\htdocs\workupjob\resources\views/admin/jobs/works.blade.php ENDPATH**/ ?>