                        ...
                        <table id="config-table" class="table table-hover table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr id="item<?php echo e($post->id); ?>">
                                    ...
                                    <td>
                                        <a title="View applicant"  href="<?php echo e(route('jobApplicantDetails',[$applicant->id, $applicant->user->username])); ?>"><i class="ti-eye"></i> Task Details </a>                                  
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xmapp\htdocs\workupjob\resources\views/users/jobs/job-applicants.blade.php ENDPATH**/ ?>