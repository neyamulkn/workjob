                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex  no-block align-items-center">
                                ...
                                <a href="{{route('sellerWithdrawRequest')}}" class="link display-5 ml-auto">{{$all}}</a>
                            </div>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex  no-block align-items-center">
                                ...
                                <a href="{{route('sellerWithdrawRequest')}}?status=pending" class="link display-5 ml-auto">{{$pending}}</a>
                            </div>
                        </div>
                    </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card" style="margin-bottom: 2px;">
                            ...
                            <form action="{{route('sellerWithdrawRequest')}}" method="get">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="control-label">Shop or seller name</label>
                                                    <input name="name" value="{{ Request::get('name')}}" type="text" placeholder="Shop or seller name" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                       ...
                                       <table id="config-table" class="table display table-bordered table-striped">
                                            ...
                                            @if(count($allwithdraws)>0)
                                                ...
                                                <tr>
                                                   ...
                                                   <td>{{$withdraw->seller->shop_name.' ('.$withdraw->seller->shop_name.')'}}</td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <a onclick="withdrawHistory('{{route("admin.getWithdrawHistory", $withdraw->seller_id)}}')" class="dropdown-item" href="javascript:void(0)" class="text-inverse" title="View Withdraw History" data-toggle="tooltip"><i class="ti-eye"></i> Withdraw History</a>
                                                            </div>
                                                        </div>
