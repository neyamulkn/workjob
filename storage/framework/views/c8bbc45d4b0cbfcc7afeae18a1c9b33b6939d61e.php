...
<?php $__env->startSection('title', 'Create New Page'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        ...
                        <a href="<?php echo e(route('page.list')); ?>" class="btn btn-info btn-sm d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Page List</a><?php endif; ?>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('page.store')); ?>" enctype="multipart/form-data" method="post" id="page">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="row justify-content-md-center">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input type="text" onchange="getSlug(this.value)" value="<?php echo e(old('title')); ?>" placeholder="Enter page name" name="title" required="" id="title" class="form-control" >
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <textarea required="" name="page_dsc" class="summernote form-control" id="page_dsc" rows="5"><?php echo e(old('page_dsc')); ?></textarea>
                                    </div>
                                </div>
                               ...
                               <div class="col-md-10"><br/>
                                    ...
                                    <div  id="seoField" style="display: none;">  
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo e(old('meta_title')); ?>"  name="meta_title" id="meta_title" placeholder = 'Enter meta title'class="form-control" >
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="meta_description" id="meta_description" rows="2" style="resize: vertical;" placeholder="Enter Meta Description"><?php echo e(old('meta_description')); ?></textarea>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="switch-box" style="top:-12px;">Status</label>
                                            ...
                                            <div class="custom-control custom-switch">
                                              <input checked="" name="status" <?php echo e((old('status') == 'on') ? 'checked' : ''); ?> type="checkbox" class="custom-control-input" id="status">
...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript">
        function getSlug(title) {
            var  url = '<?php echo e(route("page.slug")); ?>';
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xmapp\htdocs\workupjob\resources\views/admin/pages/pages.blade.php ENDPATH**/ ?>