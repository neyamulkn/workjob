        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 sticky-conent">
                    <form action="{{ route('blog.update', $blog->id) }}" data-parsley-validate method="post" enctype="multipart/form-data" class="adpost-form">
                        @csrf
                                    ...
                                    <div class="form-group">
                                        <label class="required">Search Keywords( <span style="font-size: 12px;color: #777;font-weight: initial;">Write meta tags Separated by Comma[,]</span> )</label>
                                         ...
                                         <div class="tags-default">
                                            <input type="text" name="meta_keywords[]"  data-role="tagsinput" value="{{ $blog->keywords }}" placeholder="Enter search keywords" />
                                        </div>
                                    </div>
                                </div>
